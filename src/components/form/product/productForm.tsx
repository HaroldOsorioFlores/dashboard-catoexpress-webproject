...
export const ProductForm = ({
  ...
  product?: IProduct;
  tableOptions: { title: string; btnSubmit: string };
}) => {
  const [image, setImage] = useState<File>();

  return (
    <form action="#" className="flex flex-col max-w-2xl w-full">
      <h5 className="inline-flex items-center mb-6 text-sm md:text-xl font-semibold text-gray-900 uppercase">
        {tableOptions.title}
      </h5>
      ...
      <div className="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
        <ButtonSubmit
          content={tableOptions.btnSubmit}
